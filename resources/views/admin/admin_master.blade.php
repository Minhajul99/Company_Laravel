        ...
        <div class="page-wrapper">
            ...
            <footer class="footer mt-auto">
                <div class="copyright bg-white">
                    <p>
                        &copy; <span id="copy-year">2022</span> Copyright Panda Dashboard Bootstrap Template by
                        <a class="text-primary" href="http://www.minhajul-devzone.xyz/" target="_blank">Minhaz</a>.
                    </p>
                </div>
                <script>
                    var d = new Date();
